...
const SearchSection = forwardRef((props, ref) => {
  ...
  // return은 forwardRef 내부에 한 번만 존재해야 합니다.
  return (
    <section
      ref={ref}
      style={{
        ...
        // 이 값을 60px~80px 정도로 줄여보세요.
        // 내비바 높이가 80px라면 80px일 때 내비바 바로 밑에 딱 붙습니다.
      ...
      <Container>
        ...
        <div className="text-center mb-5">
          ...
          <div style={{ maxWidth: "650px", margin: "0 auto" }}>
            <InputGroup className="mb-3 shadow-sm rounded-pill" style={{ overflow: "hidden", border: "1px solid #eee", backgroundColor: "#fff" }}>
              <Form.Control
        ...
        {/* 하단 검색 박스 */}
        <div className="border-0 rounded-4 p-4 p-lg-5 mt-5 shadow" style={{ backgroundColor: "#fff", maxWidth: "1100px", margin: "0 auto", border: "1px solid rgba(0,0,0,0.05)" }}>
          ...
          <Row className="g-3 align-items-center">
            <Col lg={3} md={6}>
              ...
              <Form.Select className="py-2 border-light shadow-sm" style={{ borderRadius: "10px", backgroundColor: "#f8f9fa" }} value={origin} onChange={(e) => setOrigin(e.target.value)}>
            ...
            <Col lg={3} md={6}>
              ...
              <Form.Select className="py-2 border-light shadow-sm" style={{ borderRadius: "10px" }} value={selectedBrand} onChange={handleBrandChange}>
